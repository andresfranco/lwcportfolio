 ...
 */
import { ObjectLookupOwnGetter as ObjectLookupOwnGetter$LWS, ReflectGetOwnPropertyDescriptor as ReflectGetOwnPropertyDescriptor$LWS, toSafeWeakMap as toSafeWeakMap$LWS, WeakMapCtor as WeakMapCtor$LWS, escapeRegExp as escapeRegExp$LWS, SANDBOX_EVAL_CONTEXT_NAME as SANDBOX_EVAL_CONTEXT_NAME$LWS, WEBPACK_REQUIRE_NAME as WEBPACK_REQUIRE_NAME$LWS, ReflectApply as ReflectApply$LWS, RegExpProtoTest as RegExpProtoTest$LWS, StringProtoReplace as StringProtoReplace$LWS, UNCOMPILED_LOCATION_NAME as UNCOMPILED_LOCATION_NAME$LWS, ArrayProtoJoin as ArrayProtoJoin$LWS, indexOfPragma as indexOfPragma$LWS, StringProtoSlice as StringProtoSlice$LWS, toSafeMap as toSafeMap$LWS, MapCtor as MapCtor$LWS, ArrayProtoShift as ArrayProtoShift$LWS, getBrand as getBrand$LWS, TO_STRING_BRAND_SET as TO_STRING_BRAND_SET$LWS, TO_STRING_BRAND_MAP as TO_STRING_BRAND_MAP$LWS, TO_STRING_BRAND_ARRAY as TO_STRING_BRAND_ARRAY$LWS, ArrayCtor as ArrayCtor$LWS, TO_STRING_BRAND_OBJECT as TO_STRING_BRAND_OBJECT$LWS, ReflectGetPrototypeOf as ReflectGetPrototypeOf$LWS, ObjectProto as ObjectProto$LWS, isNearMembrane as isNearMembrane$LWS, TO_STRING_BRAND_STRING as TO_STRING_BRAND_STRING$LWS, ObjectCtor as ObjectCtor$LWS, getNearMembraneSerializedValue as getNearMembraneSerializedValue$LWS, TO_STRING_BRAND_BIG_INT as TO_STRING_BRAND_BIG_INT$LWS, TO_STRING_BRAND_NUMBER as TO_STRING_BRAND_NUMBER$LWS, TO_STRING_BRAND_BOOLEAN as TO_STRING_BRAND_BOOLEAN$LWS, TO_STRING_BRAND_REG_EXP as TO_STRING_BRAND_REG_EXP$LWS, RegExpCtor as RegExpCtor$LWS, MapProtoEntries as MapProtoEntries$LWS, MapProtoSet as MapProtoSet$LWS, JSONParse as JSONParse$LWS, SetCtor as SetCtor$LWS, SetProtoValues as SetProtoValues$LWS, SetProtoAdd as SetProtoAdd$LWS, ObjectKeys as ObjectKeys$LWS, ObjectLookupOwnSetter as ObjectLookupOwnSetter$LWS, PromiseResolve as PromiseResolve$LWS, PromiseProtoThen as PromiseProtoThen$LWS, PromiseProtoCatch as PromiseProtoCatch$LWS, ObjectHasOwn as ObjectHasOwn$LWS } from '@locker/shared';
const {
...
const documentToValidatorMap$LWS = toSafeWeakMap$LWS(new WeakMapCtor$LWS([[document, topValidator$LWS]]));
