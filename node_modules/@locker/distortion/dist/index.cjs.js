...
function getAttributeDistortion$LWS(record$LWS, element$LWS, attributeName$LWS, attributeNamespace$LWS = sharedDom$LWS.NAMESPACE_DEFAULT) {
  const {
  ...
  const elementCtorMapByAttributeNamespaceRegistry$LWS = attributeDistortionRegistry$LWS[shared$LWS.ReflectApply(shared$LWS.StringProtoToLowerCase, attributeName$LWS, [])];
...
function normalizeAttrName$LWS(name$LWS) {
  const nameAsString$LWS = shared$LWS.toString(name$LWS);
  return shared$LWS.ReflectApply(shared$LWS.StringProtoToLowerCase, nameAsString$LWS, []);
}
