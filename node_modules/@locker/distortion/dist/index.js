 ...
 */
import { ObjectFreeze as ObjectFreeze$LWS, toSafeWeakMap as toSafeWeakMap$LWS, WeakMapCtor as WeakMapCtor$LWS, toSafeMap as toSafeMap$LWS, MapCtor as MapCtor$LWS, ReflectApply as ReflectApply$LWS, StringProtoToLowerCase as StringProtoToLowerCase$LWS, ObjectLookupOwnSetter as ObjectLookupOwnSetter$LWS, StringProtoSplit as StringProtoSplit$LWS, StringProtoReplace as StringProtoReplace$LWS, isConvertibleToString as isConvertibleToString$LWS, prefixNamespace as prefixNamespace$LWS, PromiseProtoThen as PromiseProtoThen$LWS, isNamespacePrefixed as isNamespacePrefixed$LWS, unprefixNamespace as unprefixNamespace$LWS, isObjectLike as isObjectLike$LWS, shallowCloneOptions as shallowCloneOptions$LWS, PromiseReject as PromiseReject$LWS, LockerSecurityError as LockerSecurityError$LWS, getNamespacePrefix as getNamespacePrefix$LWS, StringProtoSlice as StringProtoSlice$LWS, toSafeWeakSet as toSafeWeakSet$LWS, WeakSetCtor as WeakSetCtor$LWS, ObjectLookupOwnGetter as ObjectLookupOwnGetter$LWS, toLiveValue as toLiveValue$LWS, toString as toString$LWS, StringProtoStartsWith as StringProtoStartsWith$LWS, ArrayProtoJoin as ArrayProtoJoin$LWS, toSafeTemplateStringValue as toSafeTemplateStringValue$LWS, shallowCloneArray as shallowCloneArray$LWS, RegExpProtoTest as RegExpProtoTest$LWS, ObjectAssign as ObjectAssign$LWS, ReflectGetPrototypeOf as ReflectGetPrototypeOf$LWS, ReflectSetPrototypeOf as ReflectSetPrototypeOf$LWS, ArrayProtoIndexOf as ArrayProtoIndexOf$LWS, ArrayProtoSlice as ArrayProtoSlice$LWS, ReflectGetOwnPropertyDescriptor as ReflectGetOwnPropertyDescriptor$LWS, toSafeDescriptor as toSafeDescriptor$LWS, consoleWarn as consoleWarn$LWS, ObjectLookupOwnValue as ObjectLookupOwnValue$LWS, enquote as enquote$LWS, CHAR_QUOTE_DOUBLE as CHAR_QUOTE_DOUBLE$LWS, capitalizeFirstChar as capitalizeFirstChar$LWS, ReflectDefineProperty as ReflectDefineProperty$LWS, FunctionProtoBind as FunctionProtoBind$LWS, ReflectDeleteProperty as ReflectDeleteProperty$LWS, UNCOMPILED_LOCATION_NAME as UNCOMPILED_LOCATION_NAME$LWS, createRevokedProxy as createRevokedProxy$LWS, ObjectKeys as ObjectKeys$LWS, ArrayCtor as ArrayCtor$LWS, markLiveObject as markLiveObject$LWS, ReflectGet as ReflectGet$LWS, ObjectHasOwn as ObjectHasOwn$LWS, ReflectSet as ReflectSet$LWS, ObjectGetOwnPropertySymbols as ObjectGetOwnPropertySymbols$LWS, ArrayConcat as ArrayConcat$LWS, ReflectHas as ReflectHas$LWS, isObject as isObject$LWS, toSafeArray as toSafeArray$LWS, noop as noop$LWS, ProxyCtor as ProxyCtor$LWS, ObjectGetOwnPropertyDescriptors as ObjectGetOwnPropertyDescriptors$LWS, NumberIsInteger as NumberIsInteger$LWS } from '@locker/shared';
import { NAMESPACE_DEFAULT as NAMESPACE_DEFAULT$LWS, AttrProtoOwnerElementGetter as AttrProtoOwnerElementGetter$LWS, AttrProtoNameGetter as AttrProtoNameGetter$LWS, AttrProtoNamespaceURIGetter as AttrProtoNamespaceURIGetter$LWS, transformUncompiledSourceText as transformUncompiledSourceText$LWS, DocumentProtoCookieGetter as DocumentProtoCookieGetter$LWS, DocumentProtoCookieSetter as DocumentProtoCookieSetter$LWS, getValidator as getValidator$LWS, NodeProtoNodeNameGetter as NodeProtoNodeNameGetter$LWS, DocumentProtoHeadGetter as DocumentProtoHeadGetter$LWS, AttrProtoValueGetter as AttrProtoValueGetter$LWS, NodeProtoOwnerDocumentGetter as NodeProtoOwnerDocumentGetter$LWS, ElementProtoGetAttributeNode as ElementProtoGetAttributeNode$LWS, ElementProtoRemoveAttributeNode as ElementProtoRemoveAttributeNode$LWS, AttrProtoValueSetter as AttrProtoValueSetter$LWS, ElementProtoGetAttributeNodeNS as ElementProtoGetAttributeNodeNS$LWS, EventProtoCurrentTargetGetter as EventProtoCurrentTargetGetter$LWS, partialStructuredClone as partialStructuredClone$LWS, HTMLIFrameElementProtoSrcSetter as HTMLIFrameElementProtoSrcSetter$LWS, DOMTokenListProtoValueGetter as DOMTokenListProtoValueGetter$LWS, HTMLElementProtoDatasetGetter as HTMLElementProtoDatasetGetter$LWS, DocumentProtoCreateElement as DocumentProtoCreateElement$LWS, ElementProtoNamespaceURIGetter as ElementProtoNamespaceURIGetter$LWS, ElementProtoSetAttributeNS as ElementProtoSetAttributeNS$LWS, HTMLAnchorElementProtoHrefSetter as HTMLAnchorElementProtoHrefSetter$LWS, HTMLAnchorElementProtoHrefGetter as HTMLAnchorElementProtoHrefGetter$LWS, HTMLAnchorElementProtoHostnameGetter as HTMLAnchorElementProtoHostnameGetter$LWS, XhrCtor as XhrCtor$LWS, XhrProtoWithCredentialsSetter as XhrProtoWithCredentialsSetter$LWS, EventTargetProtoAddEventListener as EventTargetProtoAddEventListener$LWS, XhrProtoStatusGetter as XhrProtoStatusGetter$LWS, XhrProtoResponseTextGetter as XhrProtoResponseTextGetter$LWS, DocumentProtoDefaultViewGetter as DocumentProtoDefaultViewGetter$LWS, URLCreateObjectURL as URLCreateObjectURL$LWS, BlobCtor as BlobCtor$LWS, WindowEncodeURIComponent as WindowEncodeURIComponent$LWS, XhrProtoOpen as XhrProtoOpen$LWS, XhrProtoSend as XhrProtoSend$LWS, NAMESPACE_XHTML as NAMESPACE_XHTML$LWS, NAMESPACE_XLINK as NAMESPACE_XLINK$LWS, StorageProtoKey as StorageProtoKey$LWS, StorageProtoGetItem as StorageProtoGetItem$LWS, StorageProtoSetItem as StorageProtoSetItem$LWS, StorageProtoRemoveItem as StorageProtoRemoveItem$LWS, ElementProtoHasAttribute as ElementProtoHasAttribute$LWS, ElementProtoGetAttribute as ElementProtoGetAttribute$LWS, SVGElementProtoDatasetGetter as SVGElementProtoDatasetGetter$LWS, BlobProtoTypeGetter as BlobProtoTypeGetter$LWS, BlobProtoSlice as BlobProtoSlice$LWS, BlobProtoSizeGetter as BlobProtoSizeGetter$LWS, URLRevokeObjectURL as URLRevokeObjectURL$LWS, RequestProtoURLGetter as RequestProtoURLGetter$LWS, WindowLengthGetter as WindowLengthGetter$LWS, isWindow as isWindow$LWS } from '@locker/shared-dom';
...
import { sanitizeURLForElement as sanitizeURLForElement$LWS, isValidURLScheme as isValidURLScheme$LWS, parseURL as parseURL$LWS, isValidURL as isValidURL$LWS, TRUSTED_DOMAINS_REG_EXP as TRUSTED_DOMAINS_REG_EXP$LWS, isMIMETypeAllowed as isMIMETypeAllowed$LWS } from '@locker/shared-url';
const CustomElementRegistryBlockedProperties$LWS = ObjectFreeze$LWS(['define']);
const documentToSandboxAttributeDistortionRegistry$LWS = toSafeWeakMap$LWS(new WeakMapCtor$LWS());
...
const namedNodeMapToElementRegistry$LWS = toSafeWeakMap$LWS(new WeakMapCtor$LWS());
...
export { CustomElementRegistryBlockedProperties$LWS as CustomElementRegistryBlockedProperties, DocumentBlockedProperties$LWS as DocumentBlockedProperties, ElementBlockedProperties$LWS as ElementBlockedProperties, HTMLElementBlockedAttributes$LWS as HTMLElementBlockedAttributes, HTMLElementBlockedProperties$LWS as HTMLElementBlockedProperties, HTMLEmbedElementBlockedProperties$LWS as HTMLEmbedElementBlockedProperties, HTMLIFrameElementBlockedAttributes$LWS as HTMLIFrameElementBlockedAttributes, HTMLIFrameElementBlockedProperties$LWS as HTMLIFrameElementBlockedProperties, HTMLObjectElementBlockedProperties$LWS as HTMLObjectElementBlockedProperties, HTMLScriptElementBlockedAttributes$LWS as HTMLScriptElementBlockedAttributes, HTMLScriptElementBlockedProperties$LWS as HTMLScriptElementBlockedProperties, SVGElementBlockedAttributes$LWS as SVGElementBlockedAttributes, SVGElementBlockedProperties$LWS as SVGElementBlockedProperties, XSLTProcessorBlockedProperties$LWS as XSLTProcessorBlockedProperties, createAttributeDistortions$LWS as createAttributeDistortions, createBlockedPropertyDistortionFactories$LWS as createBlockedPropertyDistortionFactories, distortBlockedAttributes$LWS as distortBlockedAttributes, evaluationDistortionFactories$LWS as evaluationDistortionFactories, externalDistortionFactories$LWS as externalDistortionFactories, externalKeyedDistortionFactories$LWS as externalKeyedDistortionFactories, internalDistortionFactories$LWS as internalDistortionFactories, internalKeyedDistortionFactories$LWS as internalKeyedDistortionFactories };
/*! version: 0.16.23 */
